...
from nets.sd_training import (SDLoss, get_lr_scheduler, set_optimizer_lr,
                                weights_init)
...
if __name__ == "__main__":
    ...
    model = Body(num_classes, phi, False)
    weights_init(model)
    if model_path != '':
    ...
    if True:
        ...
        #   构建数据集加载器。
        #---------------------------------------#
        train_dataset   = Dataset(train_lines, input_shape, num_classes, epoch_length = UnFreeze_Epoch, mosaic=mosaic, train = True)
        val_dataset     = Dataset(val_lines, input_shape, num_classes, epoch_length = UnFreeze_Epoch, mosaic=False, train = False)
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(model_train, model, sd_loss, loss_history, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, save_period)
