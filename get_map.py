...
from utils.utils_pr import get_pr 
...
if __name__ == "__main__":
    ...
    if map_mode == 0 or map_mode == 1:
        print("Load model.")
        sd = SD(confidence = 0.001, nms_iou = 0.65)
        ...
        for image_id in tqdm(image_ids):
            ...
            sd.get_map_txt(image_id, image, class_names, map_out_path)
    ...
    if map_mode == 5:
        print("Get map.")
        get_pr(MINOVERLAP, True, path = map_out_path)
        print("Get PR done.")
