...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
                 stride=1, padding=1, dilation=1, groups=1, padding_mode='zeros', deploy=False, use_se=False, act="relu"):
...
class RepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=3, width_multiplier=None, override_groups_map=None, deploy=False, use_se=False):
...
def create_RepVGG_A0(deploy=False):
    return RepVGG(num_blocks=[2, 4, 14, 1], num_classes=3,
                  width_multiplier=[1, 0.75, 0.75, 0.75], override_groups_map=None, deploy=deploy)
